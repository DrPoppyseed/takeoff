...
pub const MIGRATE_JS_TO_TS_OPTION: &'static str = "Setup Typescript from a Javascript project";
// pub const ADD_LICENSE: &'static str = "Add License";

// formatter options
pub const ESLINT: &'static str = "eslint";
pub const PRETTIER: &'static str = "prettier";
pub const EDITORCONFIG: &'static str = "editorconfig";
